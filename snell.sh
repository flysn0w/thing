...
cd ~/
wget --no-check-certificate -O snell.zip https://github.com/icpz/open-snell/releases/download/v3.0.1/snell-server-linux-arm64.zip
unzip -o snell.zip
 rm -f snell.zip
